...
Multiple meta-analyses confirm this pattern (Smith, 2020; Garcia et al., 2022).
```

## Reference Format

```
Garcia, J., Martinez, A., & Lee, S. (2022). Article title. Journal Name, 15(3), 245–267. https://doi.org/10.xxxx/jes.2022.15.3.245
```
